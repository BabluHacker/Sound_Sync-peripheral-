...
void loop()
{
  ...
  if (sample > 100 && sample <=200)
  {
    ...
    delay (30); //LED stays on for a half a second
    //digitalWrite (ledPin, LOW); //LED turns off
    //turnEverythingOff();

    
  }
  else if(sample > 200 && sample <= 270){
    ...
    digitalWrite(latchPin, LOW);
    shiftOut(dataPin, clockPin, LSBFIRST, B11110011);
    digitalWrite(latchPin, HIGH);
    delay(30);
  }
  else if(sample > 270 && sample <= 350){
...
/*
  ...
  digitalWrite(latchPin, LOW);
      shiftOut(dataPin, clockPin, LSBFIRST, B0000);
      digitalWrite(latchPin, HIGH);


delay(2000);
      digitalWrite(latchPin, LOW);
      shiftOut(dataPin, clockPin, LSBFIRST, B1111);
      digitalWrite(latchPin, HIGH);
      delay(2000);
  */
}
...
void writeFirstlayer(){
  digitalWrite(latchPin, LOW);
  shiftOut(dataPin, clockPin, LSBFIRST, B0001);
  digitalWrite(latchPin, HIGH);  
...
void writeSecondlayer(){
  digitalWrite(latchPin, LOW);
  shiftOut(dataPin, clockPin, LSBFIRST, B0010);
  digitalWrite(latchPin, HIGH);  

}


void writeThiredlayer(){
  digitalWrite(latchPin, LOW);
  shiftOut(dataPin, clockPin, LSBFIRST, B0100);
  digitalWrite(latchPin, HIGH);  

}


void writeFourthlayer(){
  digitalWrite(latchPin, LOW);
  shiftOut(dataPin, clockPin, LSBFIRST, B1000);
  digitalWrite(latchPin, HIGH);  
...
void smalltolargecube()
{
  ...
  for(int i =0; i<ran; i++ )
  {
      //digitalWrite(layer[i], 1);
      digitalWrite(latchPin, LOW);
      shiftOut(dataPin, clockPin, LSBFIRST, B0011);
      digitalWrite(latchPin, HIGH);
  }
  //layer on
  for(int i =0 ;i< ran ;i++)
